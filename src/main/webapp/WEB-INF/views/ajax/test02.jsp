        ...
        $sendBtn.onclick = e => {
            ...
            */
            ...
            const fetchResult =
                ...
                // Promise 객체는 then() 메서드를 제공한다
                // then()은 비동기 방식의 요청이 성공했을 때 해당 Promise 개체 내부의 여러가지 결과를
                // 받아서 처리할수 있는 콜백 방식의 함수를 매개값으로 전달받는다
                // Prosmise 객체에 담긴 여러 정보 중 PromiseResulte에 담긴 Response 객체를 콜백 함수의 매개값으로 받아
