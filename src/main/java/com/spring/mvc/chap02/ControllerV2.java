...
@Controller
@RequestMapping("/model") // 공통 URL 맵핑 -> 메서드마다 /model을 작성할 필요가 없음
public class ControllerV2 {
    ...
    public String hobbies(Model model) {
        ...
        Collections.addAll(hobbyList, "전깃줄 앉기", "좁쌀 먹기", "짹쨱거리기", "멍때리기");
    ...
    public ModelAndView hobbies2() {
        ...
        // jsp로 보낼 데이터 생성
        String name = "야옹";
        // List.of를 통해 빠른 리스트 생성이 가능하지만 수정이 불가능함
        List<String> hobbyList = List.of("낮잠자기", "캣타워오르기", "꾹꾹이");
