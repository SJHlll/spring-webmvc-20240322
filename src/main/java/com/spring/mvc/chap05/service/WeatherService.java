...
public class WeatherService {
    ...
    public void getShortTermForecast(String area1, String area2) {
        ...
        try {
            ...
            urlBuilder.append("?" + URLEncoder.encode("serviceKey","UTF-8") + "=0Ey3%2FYOZUmZAG4EGCH5jpZZHwfbyDqucseBwbv2qiCsMDr%2BQliL3Hq2kDw6nd4fDOI5Jcj9IWG1B%2B2LECr3NWA%3D%3D"); /*Service Key*/
...
//            System.out.println(sb.toString());
            ...
            // 반복분을 이용해서 객체를 하나씩 취득한 후에 원하는 로직을 작성한다
            for (Object obj : itemArray) {

                // Object를 JSON 객체로 변환
                JSONObject item = (JSONObject) obj;

                // "category" 키에 해당하는 단일 값을 가져온다
                String category = (String) item.get("category");

                // "fcstValue" 키에 해당하는 단일 값을 가져온다
